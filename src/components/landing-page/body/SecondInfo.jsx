...
const SecondInfo = () => {
	return (
		<div className="bg-gray-100 flex flex-col-reverse md:grid md:grid-cols-2 mt-20">
			<div className="max-w-xl flex flex-col justify-center items-left ml-16 mr-8 md:mx-32">
				...
				<div className="max-w-sm mb-10 md:m-0">
